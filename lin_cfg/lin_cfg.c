...
const l_signal_handle LI0_response_error_signal = LI0_sigpNsystemLinError;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  0x08 /* 0 : 00001000 */ /* start of frame LI0_SMM_brdcst */
  ...
  ,0x80 /* 4 : 10000000 */ /* start of frame LI0_pNsystem_ctr */
  ...
  ,0x00 /* 7 : 00000000 */ /* start of frame LI0_pNsystem_ans */

  ,0x00 /* 8 : 00000000 */
  

  ,0xff /* 9 : 11111111 */ /* start of frame LI0_Seatsetting */
  ...
  ,0xfc /* 13 : 11111100 */ /* start of frame LI0_Ubootbrd */

  ,0xff /* 14 : 11111111 */
  

  ,0x00 /* 15 : 00000000 */ /* start of frame LI0_staddrbrd */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  0xFF /* 0: start of flag frame LI0_SMM_brdcst */

  ,0xFF /* 1: */


  ,0xFF /* 2: start of flag frame LI0_pNsystem_ctr */


  ,0xFF /* 3: start of flag frame LI0_pNsystem_ans */


  ,0xFF /* 4: start of flag frame LI0_Seatsetting */
  ...
  ,0xFF /* 8: start of flag frame LI0_Ubootbrd */


  ,0xFF /* 9: start of flag frame LI0_staddrbrd */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 3, LIN_RES_SUB, 4, 2, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_PUB, 7, 3, 1 , (l_u8*)&LI0_response_error_signal }
  
   ,{ LIN_FRM_UNCD, 4, LIN_RES_SUB, 9, 4, 4 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_SUB, 13, 8, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_SUB, 15, 9, 1 , (l_u8*)0 }
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x01, 0x0B, 0x15, 0x0A, 0x19, 0x1A, 0x3C, 0x3D ,0xFF};


const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x01, 0x0B, 0x15, 0x0A, 0x19, 0x1A, 0x3C, 0x3D ,0xFFFF};

/***************************************** Node Attribute*****************************************/

l_u8 lin_configured_NAD = 0x06;    /*<configured_NAD>*/
...
const l_signal_handle response_error =  LI0_sigpNsystemLinError;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_sigpNsystemLinError};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_sigpNsystemLinError};                  /*<interface_name>_< response_error>*/
...
const l_u8 lin_diag_services_supported[_DIAG_NUMBER_OF_SERVICES_] = {0xB2,0xB7,0xB6};
l_u8 lin_diag_services_flag[_DIAG_NUMBER_OF_SERVICES_] = {0,0,0};
